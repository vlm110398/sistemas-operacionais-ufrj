...
int main(void)
{
    ...
    if(cpid = fork())
    {
        ...
        //***** Fa�a com que o processo pai execute este trecho de c�digo
        ...
        //***** Aguarde o t�rmino do processo filho
        if(waitpid(-1, &status, 0) == -1) exit(EXIT_FAILURE);
        
        //***** Informe na tela que o filho terminou e que o processo pai tamb�m vai encerrar
        printf("PAI -> processo filho finalizado. finalizando processo pai\n");
        
    }
    // processo filho
    else {
        //***** Fa�a com que o processo filho execute este trecho de c�digo
        ...
        //***** O que acontece ap�s este comando?
